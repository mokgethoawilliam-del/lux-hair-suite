              ...
              {galleryImages.length > 0 ? (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {galleryImages.map((img) => (
                    <div key={img.id} className="aspect-[3/4] bg-white/5 rounded-2xl overflow-hidden group border border-white/5 relative">
                      <img 
                        src={img.image_url} 
                      ...
                      />
                      {img.caption && (
                        <div className="absolute inset-0 flex items-end p-6 bg-gradient-to-t from-brand-obsidian/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                          <p className="text-[10px] uppercase font-bold tracking-widest text-brand-gold italic">
                            {img.caption}
                          </p>
                        </div>
                      )}
